...
public class ShopGallaryImagesViewAdapter extends RecyclerView.Adapter<ShopGallaryImagesViewAdapter.ViewHolder>{
    Context context;
    List<ShopImages> getDataAdapter;
    ImageLoader imageLoader1;

    public ShopGallaryImagesViewAdapter(List<ShopImages>  getDataAdapter, Context context){
        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
    }

    public ShopGallaryImagesViewAdapter(List<ShopImages>  getDataAdapter1) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_imageview_gallarylist, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            super(itemView);
            shopImagesView =  itemView.findViewById(R.id.gallariimageView) ;
